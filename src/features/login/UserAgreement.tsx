...
export const UserAgreement: FC<UserAgreementProps> = ({
  onAgree,
  onDisagree,
}) => {
    ...
    <div className="w-full h-full flex flex-col items-center divide-y-2">
      ...
      <div className="p-4 overflow-y-scroll">
        <div className="prose max-w-full">
          ...
          <h4>1. 制作年度报告</h4>
          <p>
            枝网年度报告可以帮助您生成一份专属年度报告,
            为此，枝网需要您授权我们获取您在哔哩哔哩网站上的一些公开信息，主要包括:您的头像、昵称、历史发言记录、历史弹幕记录。您理解并同意，上述信息是枝网生成年度报告的必备信息，如您拒绝授权使用，枝网将无法为您制作并提供专属年度报告。未经您的书面同意，我们保证不以超越本协议约定范围使用您的个人信息。
          </p>
          <h4>2. 使用年度报告</h4>
          <p>
          ...
          <h4>3. 知识产权</h4>
          <p>
            年度报告内容（包括但不限于软件、技术、程序、网页、文字、图片、音频、视频、页面设计等）系开源产品；此外，您的年度报告中包含的个人发言内容的知识产权由实际权利人享有。您理解并同意，如您希望以任何形式将年度报告或年度报告中的内容素材用于本协议约定范围之外，应当经过所有实际权利人的许可。
          </p>
          <h4>4. 隐私政策</h4>
          <p>
            我们使用符合业界标准的安全防护措施保护您提供的个人信息，防止数据遭到未经授权的访问、公开披露、使用、修改，防止数据发生损坏或丢失。我们会采取一切合理可行的措施，保护您的个人信息。例如使用SSL对数据进行加密保护;我们已建立访问控制机制，确保只有授权人员才可以访问个人信息；如您对隐私政策的内容或使用我们的服务时遇到的与隐私保护相关的事直有任何疑问或进行咨询或投诉时，您均可以通过我们B站官方账号私信与我们取得联系
          </p>
        </div>
      </div>
